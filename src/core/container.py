...
import crawlers
import crawlers.fetchers
import crawlers.parsers
import intelligence.summarization
import llm
...
class Container:
    ...
    Attributes:
        ...
        chat_completion_dispatcher_factory: Factory for creating chat completion dispatchers.
