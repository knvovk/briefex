...
def create_storage_engine(*, url: str, echo: bool) -> Engine:
    ...
    This function creates and returns a SQLAlchemy engine configured with the given URL and echo setting.
    The result is cached, so subsequent calls with the same arguments return the same engine instance.
