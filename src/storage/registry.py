...
def register(model: type[Model]) -> Callable[[type[Storage]], type[Storage]]:
    ...
    This decorator registers the decorated class as the storage class for the specified model.
    It's typically used to decorate storage classes to associate them with model classes.
